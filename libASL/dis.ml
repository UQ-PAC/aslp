...
| ("ne_int",            [      ], [VInt  x; VInt  y    ])     -> Some (VBool   (sym_ne_int     x y))
| ("le_int",            [      ], [VInt  x; VInt  y    ])     -> Some (VBool   (sym_le_int     x y))
| ("lt_int",            [      ], [VInt  x; VInt  y    ])     -> Some (VBool   (sym_lt_int     x y))
| ("ge_int",            [      ], [VInt  x; VInt  y    ])     -> Some (VBool   (sym_ge_int     x y))
| ("gt_int",            [      ], [VInt  x; VInt  y    ])     -> Some (VBool   (sym_gt_int     x y))
| ("cvt_int_bits",      [_     ], [VInt  x; VInt  n    ])     -> Some (VBits   (sym_cvt_int_bits n x))
| ("is_pow2_int",       [      ], [VInt  x             ])     -> Some (VBool   (sym_is_pow2_int x))
| ("neg_int",           [      ], [VInt  x             ])     -> Some (VInt    (sym_neg_int    x))
| ("sub_int",           [      ], [VInt  x; VInt  y    ])     -> Some (VInt    (sym_sub_int    x y))
| ("shl_int",           [      ], [VInt  x; VInt  y    ])     -> Some (VInt    (sym_shl_int    x y))
| ("shr_int",           [      ], [VInt  x; VInt  y    ])     -> Some (VInt    (sym_shr_int    x y))
| ("mul_int",           [      ], [VInt  x; VInt  y    ])     -> Some (VInt    (sym_mul_int    x y))
| ("zdiv_int",          [      ], [VInt  x; VInt  y    ])     -> Some (VInt    (sym_zdiv_int   x y))
| ("zrem_int",          [      ], [VInt  x; VInt  y    ])     -> Some (VInt    (sym_zrem_int   x y))
| ("fdiv_int",          [      ], [VInt  x; VInt  y    ])     -> Some (VInt    (sym_fdiv_int   x y))
| ("frem_int",          [      ], [VInt  x; VInt  y    ])     -> Some (VInt    (sym_frem_int   x y))
| ("mod_pow2_int",      [      ], [VInt  x; VInt  y    ])     -> Some (VInt    (sym_mod_pow2_int x y))
| ("align_int",         [      ], [VInt  x; VInt  y    ])     -> Some (VInt    (sym_align_int    x y))
| ("pow2_int",          [      ], [VInt  x             ])     -> Some (VInt    (sym_pow2_int     x))
| ("pow_int_int",       [      ], [VInt  x; VInt  y    ])     -> Some (VInt    (sym_pow_int_int  x y))
| ("cvt_int_real",      [      ], [VInt  x             ])     -> Some (VReal   (sym_cvt_int_real x))
